...
public class GFRectGrid: GFGrid{
    public float forwardBoundary { get { return transform.position.z + size.z; } }  
    public float backBoundary { get { return transform.position.z - size.z; } }
    public float rightBoundary {  get { return transform.position.x + size.x; } }
    public float leftBoundary { get { return transform.position.x - size.x; } }
...
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-
	...
	public override Vector3 WorldToGrid(Vector3 worldPoint){
        //inverse矩阵的逆，AB=BA=E B是A的逆矩阵 E是单位矩阵
...
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-
    ...
    //给定一个点，返回一个最靠近的格子的XYZ顶点坐标.注意是单位格子的“中心”！！！
	public override Vector3 NearestBoxW(Vector3 fromPoint, bool doDebug = false){
		...
		//return toPoint;
        //Debug.Log( "NearestBoxG(fromPoint) : " + (NearestBoxG( fromPoint ) + 0.5f * Vector3.one) );
...
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-
    ...
    //给定一个点，返回一个最靠近的格子的XYZ顶点坐标.注意是格子的“顶点”！！！
	//returns XYZ grid coordinates of a vertex close to a given point
	public override Vector3 NearestVertexG(Vector3 fromPoint){
        //Debug.Log( string.Format( "Vertex :Given Point: {0},  Nearest Grid Point: {1}", fromPoint, RoundPoint( WorldToGrid( fromPoint ) ) ) );
	...
	*/  
	...
	public override Vector3 NearestBoxG(Vector3 fromPoint){
        //Debug.Log( string.Format( "Box :Given Point: {0},  Nearest Grid Point: {1}", fromPoint, RoundPoint( WorldToGrid( fromPoint ) - 0.5f * Vector3.one ) ) );
...
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-
	...
	public override Vector3 AlignVector3(Vector3 position, Vector3 scale, GFBoolVector3 lockAxis){
		...
		for (int i = 0; i <=2; i++){
            ...
            //Debug.Log( "spacing [i] : " + spacing[i] );
            //spacing格子的单位大小（10代表在世界中占10米）
            //Debug.Log( "scale [i] : " + scale[i] );
        ...
        //Debug.Log( "GridToWorld(newPosition) : " + GridToWorld( newPosition ) );
...
//_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-_-
	...
	private Matrix4x4 gwMatrix {
		get{
            ...
            // the scaled axes form the first three columns as Vector4 (the w component is 0)缩放轴
			_gwMatrix.SetColumn(0, _transform.right * spacing.x); 
			_gwMatrix.SetColumn(1, _transform.up * spacing.y);
			_gwMatrix.SetColumn(2, _transform.forward * spacing.z);
            // the fourth column is the position of theorigin, used for translation)
			_gwMatrix.SetColumn(3, _transform.position); 
            // the final matrix entry is always set to 1 by default
            _gwMatrix[15] = 1;
